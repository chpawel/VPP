...
class VppNewtonIntegrator : public FieldApplier{
	...
	public:
		...
		#endif
		virtual void action();
	YADE_CLASS_BASE_DOC_ATTRS_CTOR_PY(VppNewtonIntegrator,GlobalEngine,"Engine integrating newtonian motion equations.",
